...
public class UserMasterDAOImplSpring extends GenericDAO<UserMaster> implements UserMasterDAO {
	...
	private final static String SQL_SELECT = 
		"select user_id, first_name, last_name, email, mobile_number, address, created_date, updated_date, created_by, updated_by, status, is_active, version, role_id, file_path, otp, otp_time, food_style from user_master where user_id = ?";
	
	private final static String SQL_SELECT_BY_MOBILENUMBER = 
			"select user_id, first_name, last_name, email, mobile_number, address, created_date, updated_date, created_by, updated_by, status, is_active, version, role_id, file_path, otp, otp_time, food_style from user_master where mobile_number = ?";
	...
	private final static int[] SQL_INSERT_TYPES = new int[] {
			...
			java.sql.Types.VARCHAR ,  // "file_path" : VARCHAR(200) - java.lang.String
			java.sql.Types.INTEGER ,  // "otp" : INT - java.lang.Integer
			java.sql.Types.TIMESTAMP ,  // "otp_time" : TIMESTAMP - java.util.Date
			java.sql.Types.VARCHAR   // "food_style" : VARCHAR(250) - java.lang.String
	};

	private final static String SQL_INSERT = 
		"insert into user_master ( first_name, last_name, email, mobile_number, address, created_date, updated_date, created_by, updated_by, status, is_active, version, role_id, file_path, otp, otp_time, food_style ) values ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ? )";

	private final static String SQL_UPDATE = 
		"update user_master set first_name = ?, last_name = ?, email = ?, mobile_number = ?, address = ?, created_date = ?, updated_date = ?, created_by = ?, updated_by = ?, status = ?, is_active = ?, version = ?, role_id = ?, file_path = ?, otp = ?, otp_time = ?, food_style = ? where user_id = ?";
	...
	protected Object[] getValuesForInsert(UserMaster userMaster)  {
		return new Object[] {
			...
			userMaster.getOtp() , // "otp" : java.lang.Integer
			userMaster.getOtpTime() , // "otp_time" : java.util.Date
			userMaster.getFoodStyle()  // "food_style" : java.lang.String
		};
	}
    //----------------------------------------------------------------------
	...
	private void populateBean(ResultSet rs, UserMaster userMaster) throws SQLException {
		...
		userMaster.setOtp(rs.getInt("otp")); // java.lang.Integer
		if ( rs.wasNull() ) { userMaster.setOtp(null); }; // not primitive number => keep null value if any
		userMaster.setOtpTime(rs.getDate("otp_time")); // java.util.Date
		userMaster.setFoodStyle(rs.getString("food_style")); // java.lang.String
	}
